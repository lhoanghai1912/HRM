...
//   const [changedFields, setChangedFields] = useState<{ fieldName: string; fieldValue: any }[]>([]);
//   const [pickedFiles, setPickedFiles] = useState<{ fieldName: string; file: {} }[]>([]);
//   const [customConfigs, setCustomConfigs] = useState<{ fieldName: string; config: any }[]>([]);
//   const [employeeData, setEmployeeData] = useState();

//   // Handle change function (declared before using in hooks)
...
//   const filePicker = useFilePicker(field, setFormData, setPickedFiles, setChangedFields);
